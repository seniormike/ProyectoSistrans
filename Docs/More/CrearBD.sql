...
Capacidad number (5),
CondiconesTecnicas varchar(200),
...
(Tipo IN ('Cliente','Administrador','NN'))
);
...
Clasificacion varchar(10)constraint ch_r_clasificacion check (Clasificacion IN ('Entrada','Fuerte','Postre','Bebida','Acompanamiento'))
);
