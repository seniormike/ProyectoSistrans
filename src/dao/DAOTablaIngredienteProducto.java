...
public class DAOTablaIngredienteProducto 
{
	 ...
	 */
	public ArrayList<IngredienteProducto> darIngredienteProductos() throws SQLException, Exception
	{
		ArrayList<IngredienteProducto> ingredienteProducto = new ArrayList<IngredienteProducto>();
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public ArrayList<IngredienteProducto> buscarIngredienteProductoPorIdProducto(long id) throws SQLException, Exception
	{
		ArrayList<IngredienteProducto> ingredienteProducto = new ArrayList<IngredienteProducto>();

		String sql = "SELECT * FROM INGREDIENTE_PRODUCTO WHERE ID_PRODUCTO ='" + id +"'";
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void addIngredienteProducto(IngredienteProducto ingredienteProducto) throws SQLException, Exception
	{
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void updateIngredienteProducto(IngredienteProducto ingredienteProducto) throws SQLException, Exception
	{
