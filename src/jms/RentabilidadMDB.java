...
public class RentabilidadMDB implements MessageListener, ExceptionListener 
{
	...
	public Rentabilidad getRemoteProductos() throws JsonGenerationException, JsonMappingException, JMSException, IOException, NonReplyException, InterruptedException, NoSuchAlgorithmException
	{
		answer.clear();
		...
		Rentabilidad res = new Rentabilidad("A",0);
        return res;
	}
