...
public class IngredienteEquivalenteServices 
{
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response addIngredienteEquivalente(IngredienteEquivalente ingrediente)
	{
		RotondTM tm = new RotondTM(getPath());
		try {
...
//	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response updateIngredienteEquivalente(IngredienteEquivalente ingrediente)
	{
		RotondTM tm = new RotondTM(getPath());
		try {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response deleteIngredienteEquivalente(IngredienteEquivalente ingrediente)
	{
		RotondTM tm = new RotondTM(getPath());
		try {
