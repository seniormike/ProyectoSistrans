...
public class RotondTM {
	...
	public ProductoOfrecido buscarProductosOfrecidosPorId(Long idRestaurante, Long id) throws Exception
	{
		...
		try 
		{
			...
			this.conn = darConexion();
			daoProductoOfrecido.setConn(conn);
			productoOfrecido = daoProductoOfrecido.buscarProductosOfrecidosPorId(idRestaurante, id);
	 ...
	 * Existencia
	 */
	public void existeRestaurante(Long id) throws Exception 
	{
		Restaurante entity = buscarRestaurantePorId(id);
		if (entity == null) {
	 ...
	 */
	public List<Usuario> darUsuariosNoConsumidoresPorRangoFechasEnRestaurantePorAdmin(Long idUsuario, Long idRestaurante, String fecha1, String fecha2, String orderBy, String groupBy) throws Exception
	{
		List<Usuario> usuarios;
		DAOTablaUsuario daoUsuarios = new DAOTablaUsuario();
		try 
		{
			this.conn = darConexion();
			daoUsuarios.setConn(conn);
			usuarios = daoUsuarios.darUsuariosNoConsumidoresPorFecha(idUsuario, idRestaurante, fecha1, fecha2, orderBy, groupBy);
