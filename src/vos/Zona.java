...
public class Zona
{
	 ...
	 */
	public Zona(@JsonProperty(value="id")Long id, @JsonProperty(value="tipoEspacio")String tipoEspacio, @JsonProperty(value="capacidad")Integer capacidad, @JsonProperty(value="discapacitados")String discapacitados)
	{
		super();
		this.id = id;
